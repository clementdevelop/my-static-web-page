<template>
  <div class="hero17-header78" v-bind:class="rootClassName">
          ...
          <slot name="content1">
            ...
            <div class="hero17-fragment4">
              <span class="hero17-text8">
                Discover endless possibilities to transform your living space into
          ...
          <span class="thq-body-small">
            <slot name="action1">
              ...
              <div class="hero17-fragment2">
                <span class="hero17-text6">Explore Designs</span>
              </div>
            </slot>
          </span>
        </button>
          ...
          <span class="thq-body-small">
            <slot name="action2">
              ...
              <div class="hero17-fragment1">
                <span class="hero17-text5">Shop Furniture</span>
              </div>
            </slot>
          </span>
        </button>
...
export default {
  ...
  props: {
    image3Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1538688525198-9b88f6f53126?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Mjc3MDEzNXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    image8Alt: {
      type: String,
      default: 'Luxurious bathroom design',
    },
    image2Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1538577880403-f9998e75dd06?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Mjc3MDEzNnw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    image6Alt: {
      type: String,
      default: 'Chic dining area decor',
    },
    image11Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1658863025658-4a259cc68fc9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Mjc3MDEzNnw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    image5Alt: {
      type: String,
      default: 'Elegant bedroom design',
    },
    image1Alt: {
      type: String,
      default: 'Interior design inspiration',
    },
    image7Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1513161455079-7dc1de15ef3e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Mjc3MDEzNnw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    image7Alt: {
      type: String,
      default: 'Functional kitchen layout',
    },
    image12Alt: {
      type: String,
      default: 'Relaxing reading nook',
    },
    image2Alt: {
      type: String,
      default: 'Modern furniture options',
    },
    image6Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1515852216175-927860d2be80?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Mjc3MDEzNnw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    image12Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1519974719765-e6559eac2575?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Mjc3MDEzN3w&ixlib=rb-4.0.3&q=80&w=1080',
    },
    image3Alt: {
      type: String,
      default: 'Home decor ideas',
    },
    image9Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1660970781358-a68a69840eab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Mjc3MDEzN3w&ixlib=rb-4.0.3&q=80&w=1080',
    },
    image11Alt: {
      type: String,
      default: "Creative kids' room decor",
    },
    image8Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1511401139252-f158d3209c17?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Mjc3MDEzOHw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    image5Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1591935893481-4a5fa6671ec0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Mjc3MDEzOXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    image4Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1572048572872-2394404cf1f3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Mjc3MDE0MHw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    image10Alt: {
      type: String,
      default: 'Outdoor living space inspiration',
    },
    image4Alt: {
      type: String,
      default: 'Cozy living room setting',
    },
    image10Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1513716875652-59c99449ee70?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Mjc3MDE0MHw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    image9Alt: {
      type: String,
      default: 'Stylish home office setup',
    },
    image1Src: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1517467139951-f5a925c9f9de?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0Mjc3MDE0MHw&ixlib=rb-4.0.3&q=80&w=1080',
    },
